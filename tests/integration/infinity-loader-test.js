...
module('infinity-loader', function (hooks) {
  ...
  hooks.beforeEach(function () {
    ...
    this.checkScrollableHeight = () => true;
  });
  ...
  test('it renders loading text if no block given', async function (assert) {
    ...
    await render(
      hbs`<InfinityLoader @infinityModel={{this.infinityModel}} @infinity={{this.infinityServiceMock}} @checkScrollableHeight={{this.checkScrollableHeight}}`
    );
    assert.strictEqual(
  ...
  test('hideOnInfinity works on first render', async function (assert) {
    ...
    await render(hbs`<InfinityLoader
      ...
      @checkScrollableHeight={{this.checkScrollableHeight}}
    `);
  ...
  test('hideOnInfinity does not work if hideOnInfinity=false', async function (assert) {
    ...
    await render(
      hbs`<InfinityLoader @infinityModel={{this.infinityModel}} @hideOnInfinity={{false}} @infinity={{this.infinityServiceMock}} @checkScrollableHeight={{this.checkScrollableHeight}}`
    );
    assert.strictEqual(
