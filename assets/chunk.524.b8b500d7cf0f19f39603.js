...
var c,f,h,p,g,b,m,y=(0,require("@ember/template-factory").createTemplateFactory)({id:"Sx39E2el",block:'[[[41,[30,0,["shouldShow"]],[[[1,"  "],[11,0],[16,0,[29,[[30,0,["loaderClassNames"]],[52,[30,0,["viewportEntered"]]," in-viewport"],[52,[30,0,["isDoneLoading"]]," reached-infinity"]]]],[24,"data-test-infinity-loader",""],[17,1],[4,[38,2],[[30,0,["didInsertLoader"]],[30,0]],null],[4,[38,3],[[30,0,["_initialInfinityModelSetup"]],[30,2]],null],[4,[38,3],[[30,0,["_loadStatusDidChange"]],[30,3]],null],[4,[38,3],[[30,0,["_loadStatusDidChange"]],[30,4]],null],[12],[1,"\\n"],[41,[48,[30,5]],[[[1,"      "],[18,5,[[30,0,["infinityModelContent"]]]],[1,"\\n"]],[]],[[[41,[30,0,["isDoneLoading"]],[[[1,"        "],[10,1],[12],[1,[30,0,["loadedText"]]],[13],[1,"\\n"]],[]],[[[1,"        "],[10,1],[12],[1,[30,0,["loadingText"]]],[13],[1,"\\n"]],[]]]],[]]],[1,"  "],[13],[1,"\\n"]],[]],null]],["&attrs","@infinityModel","@hideOnInfinity","@reachedInfinity","&default"],false,["if","div","did-insert","did-update","has-block","yield","span"]]',moduleName:"/home/runner/work/ember-infinity/ember-infinity/ember-infinity/dist/components/infinity-loader.js",isStrictMode:!1})
...
var r=i(66628),n=i(82735),o=i.n(n),a=i(65378)
...
const O=u.create(S)
if(this._ensureCompatibility(O.store,O.storeFindMethod),this.infinityModels.pushObject(O),w){(0,b.assert)("timestamp must be a positive integer in milliseconds",w>0)
const t=e+=L,i=this._cachedCollection,r=i[t]
if(r){const e=Object.keys(r)[0]
if(e>Date.now())return r[e]
y(i,O,t,w)}else y(i,O,t,w)}return d.create({promise:this.loadNextPage(O)})}loadNextPage(e,t=1){return e.isLoaded=!1,e.loadingMore=!0,this._previousScrollHeight=this._calculateHeight(e),this._requestNextPage(e,t).then((t=>this._afterInfinityModel(t,e))).then((t=>this._doUpdate(t,e))).then((e=>{if(1===t)e.incrementProperty("currentPage")
...
return e.onRequestNextPage?e.onRequestNextPage(e,i,r):e.store[e.storeFindMethod](i,r)}_doUpdate(e,t){t.isLoaded=!0
...
e.exports=require("rsvp")},15434:(e,t,i)=>{e.exports=function(){var e=_eai_d,t=_eai_r
function r(e){return e&&e.__esModule?e:Object.assign({default:e},e)}window.emberAutoImportDynamic=function(e){return 1===arguments.length?t("_eai_dyn_"+e):t("_eai_dynt_"+e)(Array.prototype.slice.call(arguments,1))},window.emberAutoImportSync=function(e){return t("_eai_sync_"+e)(Array.prototype.slice.call(arguments,1))},e("@faker-js/faker",[],(function(){return r(i(73725))})),e("@feldico/ember-infinity/components/infinity-loader",["@glimmer/tracking","@ember/runloop","@ember/object","@ember/service"],(function(){return r(i(36816))})),e("@feldico/ember-infinity/services/infinity",["@ember/service","@ember/array/proxy","@glimmer/tracking","@ember/object","rsvp","@ember/application","@ember/runloop"],(function(){return r(i(93869))})),e("ember-infinity/lib/infinity-model",["@ember/array/proxy","@glimmer/tracking","@ember/object","rsvp"],(function(){return r(i(25178))})),e("ember-modifier",["@ember/application","@ember/modifier","@ember/destroyable"],(function(){return r(i(71699))})),e("fast-deep-equal",[],(function(){return r(i(92575))})),e("intersection-observer-admin",[],(function(){return r(i(43404))})),e("miragejs",[],(function(){return r(i(96757))})),e("pretender",[],(function(){return r(i(62503))})),e("raf-pool",[],(function(){return r(i(98841))}))}()},41183:function(e,t){window._eai_r=require,window._eai_d=define}},i={}
...
i.forEach(t.bind(null,0)),i.push=t.bind(null,i.push.bind(i))})(),r.O(void 0,[972],(()=>r(41183)))
var n=r.O(void 0,[972],(()=>r(15434)))
