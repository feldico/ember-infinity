...
import { c as checkInstanceOf, a as convertToArray, I as InfinityModel, o as objectAssign, p as paramsCheck } from '../infinity-model-lpg2-q4O.js';
...
class Infinity extends Service {
  ...
  */
  model(modelName, options, ExtendedInfinityModel) {
    ...
    const preContent = A(paramsCheck('preContent', options, infinityModelForParamsCheck)) || A();
    const meta = paramsCheck('meta', options, infinityModelForParamsCheck) || {};
  ...
  _requestNextPage(infinityModel, increment) {
    ...
    if (infinityModel.onRequestNextPage) {
      return infinityModel.onRequestNextPage(infinityModel, modelName, params);
    }
