...
import { c as checkInstanceOf, a as convertToArray, I as InfinityModel, o as objectAssign, p as paramsCheck } from '../infinity-model-DxqGNvIf.js';
...
class Infinity extends Service {
  ...
  */
  model(modelName, options, ExtendedInfinityModel) {
    ...
    A(paramsCheck('content', options, infinityModel)) || A();
